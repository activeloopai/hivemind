...
import { delimiter as delimiter2, join as join10 } from "node:path";
...
var { log: wikiLog } = makeWikiLogger(join12(homedir6(), ".codex", "hooks"));
...
async function main() {
  ...
  spawnDetachedNodeWorker(join12(__bundleDir, "graph-deps-worker.js"));
